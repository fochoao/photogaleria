	...
	if (!empty($_GET['show_image']) && is_numeric($_GET['show_image']) || empty($_GET['show_image'])) {
		...
		if (!empty($photo_id) && is_numeric($photo_id)) {
			...
			if (isset($previous_photo_id)) {
				print '<a href="index.php?show_image='.$previous_photo_id.'" class="back" id="previous-button" page="index.php?show_image='.$previous_photo_id.'" photo="'.$photo_dir.$previous_photo_file.'" title="'.$previous_photo_name.'"  alt="'.$previous_photo_name.'">&lt;</a>'."\n";
			}
			...
			if (isset($next_photo_id)) {
				print '<a href="index.php?show_image='.$next_photo_id.'" class="forward" id="forward-button" page="index.php?show_image='.$next_photo_id.'" photo="'.$photo_dir.$next_photo_file.'" title="'.$next_photo_name.'" alt="'.$next_photo_name.'">&gt;</a></p>'."\n";
			}
